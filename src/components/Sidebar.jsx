...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { path: '/faturamento', name: 'Faturamento', icon: <FileText size={20} />, show: isAdmin },
    { path: '/configuracoes', name: 'Configurações', icon: <Settings size={20} />, show: isAdmin },
    { path: '/usuarios', name: 'Usuários', icon: <UserCog size={20} />, show: isAdmin },
  ];
